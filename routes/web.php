...
Route::permanentRedirect('/docs/feature-experiment', '/docs/feature-experiment/overview');
Route::permanentRedirect('/docs/web-experiment', '/docs/web-experiment/set-up-a-web-experiment');
