...
4. Create a new branch using the issue's key or ID as the branch name. For example, `DOC-###` where `###` is a number. If a branch by that name exists, delete it and recreate it from main.
...
Important: If you are unsure of what to write or the next step you should perform, stop immediately.