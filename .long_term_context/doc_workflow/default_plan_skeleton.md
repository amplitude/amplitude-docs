...
- [ ] Review `.long_term_context/style/client_style_guide.md` to ensure that the style guide is followed  
- [ ] Review `.long_term_context/doc_workflow/client_instructions.md` to ensure that the client instructions are followed  
