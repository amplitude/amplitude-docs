---
id: a236d85e-010f-48bd-aa4d-e592f0431ebe
...
updated_at: 1720115263
---

{{partial:admonition type="beta" heading="This integratin is in Closed Beta"}}
...
{{partial:admonition type="note" heading="Choose the correct integration"}}
...
- Amplitude uses the **IdentityLink** API of Kochava to send user-attributes and this will link the user-level data with the device ID. The user attributes sent by Amplitude will not be tied if the Install event with the same device ID wasn't received at Kochava before.
...
- Relevant limits for Kochava events are:
    - Kochava doesn't impose any hard limits on quantity or velocity; however, requests sent too quickly will return 429 responses. Amplitude will handle these automatically. 
