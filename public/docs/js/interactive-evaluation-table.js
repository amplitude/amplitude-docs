...
document.getElementById('track_assignment').addEventListener("change", function () {
  var shouldNotTrack = document.getElementById('track_assignment').value === 'no-track';
  if (shouldNotTrack) {
...
setupApiTable({
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fields) {
    var deploymentKey, userId, deviceId, flagKeys, context, trackAssignment, serverZone, uri, headers, response, body, result;
