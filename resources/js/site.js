// This is all you.
// another line
export function setCurlVariable(id, query) {
...
export function setupCurlVariable(id, query) {
...
export function setFailureTip(message) {
 ...
 */
export function setupApiTable(ids, action) {
