...
If your project permits sending start or end session events (which you can enable using [Android SDK](/docs/sdks/analytics/android/android-kotlin-sdk#track-sessions) or [iOS SDK](/docs/sdks/analytics/ios/ios-swift-sdk#track-sessions)), anytime your app launches in the foreground, it will send a `Start
