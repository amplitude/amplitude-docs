...
{{partial:admonition type="note" heading="Immature cohorts"}}
An immature cohort for a specific N-day period consists of users who have begun but have not yet finished the full N-day window. For instance, a cohort starting today isn't considered mature until the N-day period is complete, typically by the next day and beyond.
{{/partial:admonition}}
