...
詳しくは、こちらの[Amplitude Experimentでのホールドアウトグループの使い方](https://amplitude.com/docs/experiment/advanced-techniques/holdout-groups-exclude-users)についてのヘルプセンターの記事をご覧ください。
