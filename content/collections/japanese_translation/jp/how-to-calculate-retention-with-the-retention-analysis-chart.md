...
**注：**棒グラフ形式では、X軸にはデフォルトで最も一般的な時間の単位（日、週、月）が含まれます。[リターン時点（カスタム）](https://amplitude.com/docs/faq/retention-analysis#h_01FA68RVF9FY09M7BXB66SGVWX)を使用することでこれらをカスタマイズできます。
