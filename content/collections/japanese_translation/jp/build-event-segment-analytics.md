...
[イベントセグメンテーション分析を解釈](/docs/analytics/charts/event-segmentation/event-segmentation-interpret-1)する方法についての詳細は、このヘルプセンターの記事を参照してください。また、イベントセグメンテーションチャートについてのFAQは[こちら](https://amplitude.com/docs/faq/event-segmentation)です。
