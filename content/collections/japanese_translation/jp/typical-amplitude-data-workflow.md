...
このガイドでは`、メイン`ブランチを拡張した後、およびチームの標準的なワークフローについて説明します。お客様の導入環境でよく見られる[ベストプラクティ](https://amplitude.com/docs/data/amplitude-data-get-started)スとアプローチを分析し、お客様の購入プロセスを支援することを目的としています。
