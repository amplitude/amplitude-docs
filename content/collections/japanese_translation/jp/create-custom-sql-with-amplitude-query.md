...
| app*番号(38、0)* | プロジェクトの[設定ページ](https://amplitude.com/docs/admin/account-management/account-settings#projects)に表示されるプロジェクトID。123456 |
| city*VARCHAR* | 市。
"San Francisco" |
...
| groups*VARIANT* | グループタイプ。詳細は、[Accountsのドキュメント](https://amplitude.com/docs/analytics/account-level-reporting#account-level-reporting)を参照してください。 |
...
Amplitudeによるユニークユーザーの追跡方法については、[こちら](https://amplitude.com/docs/data/sources/instrument-track-unique-users)の記事をご覧ください。
