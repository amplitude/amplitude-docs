...
もしまだの場合は、[Amplitudeのチャート作成](/docs/analytics/charts/build-charts-add-events)の基本や、[イベントセグメンテーション](/docs/analytics/charts/event-segmentation/event-segmentation-build)チャートの作成方法をあらかじめ学んでおきましょう。また、イベントセグメンテーションチャートについてのFAQは[こちら](https://amplitude.com/docs/faq/event-segmentation)です。
