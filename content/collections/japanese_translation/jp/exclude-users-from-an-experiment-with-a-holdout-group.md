...
* * * エクスポージャーイベント
		...
		* 統計手法：[T検定](https://amplitude.com/docs/experiment/experiment-theory/analyze-with-t-test)（*バリアントごとに必要なサンプル数*10,000に設定）
		* 分析期間
...
さらに詳しくは、こちらの[相互排除グループについてのAmplitudeヘルプセンターの記事](https://amplitude.com/docs/experiment/advanced-techniques/mutually-exclusive-experiments)をお読みください。
