...
* Start/End Sessionイベントは月次[イベント数の制限](https://amplitude.com/docs/faq/limits#h_5d6b52ca-cb1e-4497-82a3-81b86b2f30ff)にカウントされます。
...
また、[hidden](https://amplitude.com/docs/data/display-names-in-amplitude-data#change-visibility-status-for-an-event-or-property)、[inactive](https://amplitude.com/docs/data/display-names-in-amplitude-data#change-activity-status-for-an-event)および[deleted](https://amplitude.com/docs/data/display-names-in-amplitude-data#delete-and-undelete-events-and-event-properties)の各イベントはセッションの長さの計算に**含まれません**。例えば、次の一連のイベントがあるとします:
