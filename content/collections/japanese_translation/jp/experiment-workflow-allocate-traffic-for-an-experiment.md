...
*「この実験の対象者」*の下で、ユーザーセグメントを定義するには、*[ターゲットユーザー]*を選択し、[セグメント1]をクリックします。次に、Amplitude Analyticsで[ユーザーセグメントを構築するのと同じステップに従ってください。](https://amplitude.com/docs/analytics/charts/build-charts-add-events)
...
次に、[実験をユーザーにロールアウトします](https://amplitude.com/docs/experiment/workflow/experiment-test)。
