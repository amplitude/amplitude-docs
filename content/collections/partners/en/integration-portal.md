...
---
The Amplitude Integration Portal is your gateway to building data connections for Amplitude customers. As a partner, the portal gives you the tools and resources to define, test, and publish your integration tile directly in the Amplitude app.

With the Integration Portal, partners can access comprehensive documentation, code samples, and best practices that guide developers through the steps for integration.

## Getting started

Amplitude makes it easy for partners to self-define and add all the contextual information for their integration tile in the Amplitude app. Using the Integration Portal, you can:
...
The Integration Portal supports partners who want to build these kinds of integrations:
...
- [Cohorts](/docs/partners/create-a-cohort-sync-integration) - Build your own Amplitude Data Destination cohort tile to enable users to sync cohorts (audiences) from Amplitude to your platform through a series of REST API calls.
...
2. Create your partner information and enter the following:
...
4. **Amplitude Engineering team reviews integration**: During the review process, the Amplitude team validates the integration. The Amplitude team may reach out to you if they have questions.
