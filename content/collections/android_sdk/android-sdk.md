...
This is a maintenance SDK and will only receive bug fixes until deprecation. Upgrade to the [Android Kotlin SDK](/sdks/analytics-sdks/android-sdk/android-kotlin-sdk) which supports plugins, SDK integrations, and more.
{{/partial:admonition}}
