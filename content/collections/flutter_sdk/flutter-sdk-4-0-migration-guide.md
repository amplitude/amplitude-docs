...
---
Amplitude Flutter SDK 4.0 features default event tracking, simplified interfaces, and wraps the latest [Amplitude iOS](/docs/data/sdks/analytics/ios-swift/) and [Android Kotlin](/docs/data/sdks/analytics/android-kotlin/) SDKs. 
