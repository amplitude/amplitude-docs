...
4. (Optional) Configure S3 Storage Integration for Snowflake: You can choose to set up a storage integration to provide an additional layer of security when Amplitude accesses your Snowflake data. Learn more about Snowflake storage integration [here](https://docs.snowflake.com/en/user-guide/data-load-s3-config-storage-integration).
