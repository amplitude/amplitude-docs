...
4. (Optional) Configure S3 Storage Integration for Snowflake: You can set up a storage integration to provide an additional layer of security when Amplitude accesses your Snowflake data. For more information, see Snowflake's [Snowflake storage integration](https://docs.snowflake.com/en/user-guide/data-load-s3-config-storage-integration) documentation.
