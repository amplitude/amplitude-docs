...
In Guides and Surveys experiments, you can test whether showing a guide or survey affects user behavior:

- **Control**: Users in the control group don't see the guide or survey.
- **Variants**: Users assigned to variants see the guide or survey you create.
...
After you select an experiment type, Guides and Surveys adds a control and two variants with autogenerated keys:

- **Control**: Users assigned to the control don't see your guide or survey. This serves as your baseline for measuring impact.
- **Variants**: Users assigned to variants see your guide or survey. Create multiple variants to test different versions of content or design.

To rename a variant, select it and click *More options*. Update the name, duplicate, or delete the variant here.
...
| Option                      | Description                                                                                                                                                                                                                                                                                               |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Complete experiment         | Declare a winner. If one of the variants is the winner, Amplitude archives the losing variant, and publishes the winning variant.<br/><br/>If you select the control as the winner, the experiment returns to a state as if you just created it, and sets the rollout of the control to 100%. This means no users see the guide or survey.  |
