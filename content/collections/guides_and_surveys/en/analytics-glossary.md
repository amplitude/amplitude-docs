    ...
    event_row:
      ...
      -
        ...
        event_description: |-
          ...
          For pins, this event can fire when the pin target is selected. Pins are unique in that clicks outside of the pin can generate a "Guide Step Completed" event:
