...
glossary:
      ...
      -
        ...
        event_specific_properties: |-
          - `Title` string. The title of the article/video
      ...
      -
        ...
        event_specific_properties: |-
          ...
          - `URL` string. The URL of the article
          - `Source Key` string. The source key of the article (if available)
          - `Duration` number. The duration in milliseconds that the article was viewed
      -
        id: rc013
      ...
      -
        ...
        event_specific_properties: |-
          ...
          - `Type` string. The type of the clicked result (e.g., 'document', 'video', 'resource', 'nudge')
      ...
      -
        ...
        event_specific_properties: |-
          ...
          - `Type` string. The type of the clicked recommendation (e.g., 'document', 'video', 'link', 'nudge')
      ...
      -
        ...
        event_specific_properties: |-
          ...
          - `Type` string. The type of the clicked quick link (e.g., 'document', 'video', 'link', 'nudge')
