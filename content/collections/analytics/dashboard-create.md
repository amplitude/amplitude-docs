...
2. Hover over the ![official_icon.png](/docs/output/img/analytics/official_icon.png) icon next to the dashboard’s title.
...
![dashboards_final_section_more_menu_image.png](/docs/output/img/analytics/dashboards_final_section_more_menu_image.png)
