...
- **Ads**: Provides an overview of your ad campaigns (for example, Google Ads and Facebook Ads) with key metrics like Impressions, Clicks, CTR (Click-Through Rate), CPC (Cost Per Click), CAC (Customer Acquisition Cost), and ROAS (Return on Ad Spend), plus flexible settings for acquisition and revenue tracking.
