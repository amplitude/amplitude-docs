...
**NOTE:** This article is second in a series about Historical Counts. If you haven't done so already, read [Historical Count, part 1: Track user behavior for different instances of each user action](/docs/analytics/historical-count-1). 
...
![historical_count_2.png](/docs/output/img/analytics/historical_count_2.png)
