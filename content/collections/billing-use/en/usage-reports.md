...
---
Amplitude's **usage reports** help you identify trends and patterns of Amplitude usage within your organization. Use them to better understand where your company's analytics practice is strongest, as well as opportunities to further maximize the value your organization gets from Amplitude.

## Access usage reports

Usage reports include ten charts (visible on the User Metrics tab) that deliver the metrics you need to effectively drive Amplitude adoption in your organization, as well as a report (visible on the Event Usage tab) that describes how your organization uses ingested events within Amplitude across all projects.

Access usage reports by navigating to *Settings > Organization settings > Usage Reports*.
...
User metrics provide insight on how users within your organization use Amplitude over the defined time period.
...
The User Metrics panel provides information on active user count, top users and teams, and depth of engagement. You can set the active users chart to display data on a monthly, weekly, or daily basis by clicking on the appropriate buttons in the top corner. The summary statistics included in this chart work the same as the ones in the [KPI view](#detailed-kpis).
...
The Events Usage tab provides a downloadable, **organization-level** usage report in .CSV or JSON format, detailing use of events across all projects and portfolios within your org. This helps you review Amplitude use across your organization. Generate an up-to-date report whenever you like by clicking **Generate Report**.
...
Both files include all events Amplitude has ever ingested. This includes both blocked and deleted events.
