...
| `applyBackgroundColorToBlockedElements` | `boolean` | No | `false` | Applies a light grey background to elements with the `amp-block` class so blocked elements are visible in the replay. |
