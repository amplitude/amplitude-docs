...
| `sessionId` | `Long`    | No      | `-1`          | Sets an identifier for the users current session. The value must be in milliseconds since epoch (Unix Timestamp), or -1 to indicate no sessionId is currently set.                                                                                                                                                                                                             |
