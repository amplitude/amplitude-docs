...
- You're using the [Session Replay Browser SDK Plugin](/docs/session-replay/session-replay-plugin) version `@amplitude/plugin-session-replay-browser@1.22.0` or higher. TRC doesn't work with the standalone SDK.
