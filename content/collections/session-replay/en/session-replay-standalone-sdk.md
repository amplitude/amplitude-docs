...
| `useWebWorker` | `boolean` | No       | `false`         | If true, the SDK compresses replay events using a web worker. This offloads compression to a separate thread, improving performance on the main thread.                                                                                                                                                                                                                              |
