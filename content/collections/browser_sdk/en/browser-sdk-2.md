...
| `identify`                 | `IIdentify`. Calls "identify" with this object during initialization. Called before autocapture events, like `session_start`, ensuring proper attribution of events. | `undefined`                             |
