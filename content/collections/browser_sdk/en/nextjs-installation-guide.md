...
// Or if using Analytics SDK only:
...
export function AmplitudeProvider({ 
  ...
  return (
    <AmplitudeContext.Provider value={{ isInitialized, amplitude }}>
      {children}
...
import { init, track, identify, flush } from '@amplitude/analytics-node';
...
export function handleUserSession(amplitude: any) {
  // On login
