...
| `groups`              | Optional. Dictionary. This feature is only available to Enterprise customers who have purchased the [Accounts add-on](https://amplitude.com/docs/analytics/account-level-reporting). A dictionary of key-value pairs that represent groups of users. Setting groups allows you to use [account-level reporting](https://amplitude.com/docs/analytics/account-level-reporting). You can track up to 5 unique group types and 10 total groups. |
