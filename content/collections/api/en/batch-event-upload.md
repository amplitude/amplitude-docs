...
|     `currency`     |                                                                                                                                           <span class="optional">Optional</span>. String. The currency for the purchased item, specified as a 3-character uppercase [ISO 4217](https://www.iban.com/currency-codes) code (e.g., USD, EUR).                                                                                                                                            |
