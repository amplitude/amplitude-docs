...
Google Analytics 4 (Web) destination works with a web application instrumented with Google Tag (gtag.js). If you are working with an iOS or Android mobile application using Firebase, set up a [Google Analytics 4 (iOS/Android)](/data/destination-catalog/google-analtics-4-web) destination.
{{/partial:admonition}}
