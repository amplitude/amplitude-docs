...
7. In **Select and filter events** choose which events you want to send. Choose only the events you need in Movable Ink.
8. (optional) In the **Select additional properties** section, select additional properties which Amplitude will send to Movable Ink. Amplitude sends only the properties you select.
...
10. (optional) In the **Select additional properties** section, select any additional user properties you want to send to Movable Ink. Amplitude sends only the properties you select here. 
