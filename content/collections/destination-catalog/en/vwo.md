...
* Leverage VWO experiment data to create targeted segments and deliver personalized campaigns in Amplitude.  
...
1. [Enable the setting in VWO](#enable-the-setting-in-vwo)  
2. [Configure VWO Amplitude Destination in Amplitude](#configure-vwo-amplitude-destination-in-amplitude)  
3. [Sync Amplitude Cohort with VWO destination](#sync-amplitude-cohort-with-vwo-destination)  
4. [Import Amplitude Audience in VWO](#import-amplitude-audience-into-vwo)
