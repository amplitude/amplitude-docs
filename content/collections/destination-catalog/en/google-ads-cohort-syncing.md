...
- You should have an understanding of [Amplitude Activation](/docs/data/audiences#how-amplitude-activation-delivers-personalized-experiences-to-your-users) and [Behavioral Cohorts](/docs/analytics/behavioral-cohorts) before setting up this integration.
