...
- You should have an understanding of [Amplitude Audiences](/docs/data/audiences) and [Behavioral Cohorts](https://amplitude.com/docs/analytics/behavioral-cohorts) before setting up this integration.
