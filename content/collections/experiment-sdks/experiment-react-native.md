...
| Parameter | Requirement | Description |
| --- | --- | --- |
| `key` | required | The **flag key** to identify the [flag or experiment](/experiment/data-model#flags-and-experiments) variant to track an [exposure event](t/experiment/under-the-hood/event-tracking#exposure-events) for. |
