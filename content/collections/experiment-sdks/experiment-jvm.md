...
| `eventUploadThreshold` | `setEventUploadThreshold()` in the underlying [Analytics SDK](/sdks/analytics/java/jre-java-sdk#configuration) | `10` |
| `eventUploadPeriodMillis` | `setEventUploadPeriodMillis()` in the underlying [Analytics SDK](/sdks/analytics/java/jre-java-sdk#configuration) | `10000` |
| `useBatchMode` | `useBatchMode()` in the underlying [Analytics SDK](/sdks/analytics/java/jre-java-sdk#configuration) | `true` |
