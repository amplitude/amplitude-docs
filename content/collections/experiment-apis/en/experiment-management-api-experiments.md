...
| `targetSegments`                       | Optional    | object array      | See the [`targetSegments`](#targetsegments) table for more information. When you provide the `targetSegments` object, it replaces existing target segments. This option doesn't support cohorts. |
