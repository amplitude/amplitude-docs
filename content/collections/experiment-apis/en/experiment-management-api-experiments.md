...
| `decision`                             | Optional    | string       | Options include `rollout`, `rollback`, `continue-running`.
                                                              |
| `decisionReason`                       | Optional    | string       | reason why you made the decision you made
                                                              |
| `rolledOutVariant`                     | Optional    | string       | the variant key or name that you rolled out to
                                                              |
