...
Amplitude applies this feature at the project level. You must have admin privileges to use it. Admins can control the following notification types:
...
1. Navigate to *Settings > Organization settings > User Privacy Notifications* and ensure you're in the project you want to manage.
