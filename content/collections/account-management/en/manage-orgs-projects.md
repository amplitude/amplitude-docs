...
source: 'https://amplitude.com/docs/admin/account-management/manage-orgs-projects'
landing: false
...
| Currency Display    | [The unit of currency displayed for revenue metrics](https://amplitude.com/docs/admin/account-management/currency-unit).                                                                                                                                                                                                                                                                                                                                                                                                                              |
| User Downloads      | This is where you can enable or disable the [download users](https://amplitude.com/docs/analytics/microscope#download-users) feature in the Microscope, in the export cohorts feature, and the export breakdown tables.                                                                                                                                                                                                                                                                                                                                                                 |
