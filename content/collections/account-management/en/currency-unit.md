...
Follow these steps to modify your currency display for a project:

1. Navigate to *Settings > Organization settings > Projects* to view a list of your projects.
2. Select the project you want to modify the currency display for.
...
After you make this change, you can see the new unit of currency in:
