...
---
Amplitude's Role-based Access Controls (RBAC) system unifies permissions across all Amplitude products and features. This guide describes best practices for designing and governing access at the project level rather than separately for each project.
...
All members of a group inherit the same set of permissions for the same projects. This simplifies onboarding, offboarding, and audits.
...
* The projects each team needs to access.

In other words, consider both the team's function or use case and the data or product context they need to do their job.

Ensure each group describes what the members do and where they do it.

#### Keep groups project-scoped and purposeful

A well-designed group has a clear function, a set of projects, and a consistent role.
...
* Avoid catchall groups like `All Analysts` or `Marketing Team`. They create confusion and overexpose parts of your Amplitude environment.
