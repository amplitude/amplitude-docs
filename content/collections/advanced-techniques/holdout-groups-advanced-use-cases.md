...
---
This article reviews advanced use cases you may run into while using [holdout groups](/docs/experiment/advanced-techniques/holdout-groups-exclude-users) in Amplitude Experiment. 
