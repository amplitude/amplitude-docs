...
- [Build a Funnel Analysis chart](https://academy.amplitude.com/build-a-funnel-analysis-chart)
- [Diagnose conversion issues with Funnel and Path analyses](https://academy.amplitude.com/path/diagnose-conversion-issues)
{{/partial:admonition}}
