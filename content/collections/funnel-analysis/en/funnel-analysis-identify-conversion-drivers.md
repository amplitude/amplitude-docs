...
source: 'https://amplitude.com/docs/analytics/charts/funnel-analysis/funnel-analysis-identify-conversion-drivers'
...
{{partial:admonition type='note'}}
 Use [Amplitude Experiment](https://amplitude.com/docs/experiment/overview) to determine causality. 
{{/partial:admonition}}
